...
public final class FragmentReviewsListBinding implements ViewBinding {
  ...
  private FragmentReviewsListBinding(@NonNull RecyclerView rootView, @NonNull RecyclerView list) {
  ...
  public static FragmentReviewsListBinding bind(@NonNull View rootView) {
    ...
    return new FragmentReviewsListBinding((RecyclerView) rootView, list);
  }
}
